...
experiments = ["belair_09-27-2023","campus_09-25-2023","forest_04-21-2023"]

for experiment in experiments:
    for trajectory in os.listdir(f"/home/user/data/{experiment}/data_rectified/"):
        for exposure in exposure_time:
            # Specify the folder path
            folder_path = f"/home/user/data/{experiment}/data_rectified/{trajectory}/camera_right/{exposure}/"
            ...
            output_file = f'/home/user/data/{experiment}/data_rectified/{trajectory}/times_files/times_{exposure}.txt'
