...
./Main/stereo/stereo_borealhdr Vocabulary/ORBvoc.txt Main/stereo/calib_files/BOREALHDR_april.yaml ../../data/$experiment/data_high_resolution/$file_name/camera_left/$exposure_time/ ../../data/$experiment/data_high_resolution/$file_name/camera_right/$exposure_time/ ../results/$file_name/orbslam2/$exposure_time/
