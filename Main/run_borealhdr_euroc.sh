...
./Main/stereo_borealhdr_euroc Vocabulary/ORBvoc.txt Main/calib_files/WARTHOG.yaml ../data_examples/$experiment/camera_left ../data_examples/$experiment/camera_right ../data_examples/$experiment/times.txt  
